...
- **Fix Plan**: Externalize timestamp generation, or inject `0` if not provided by a verified envelope. Ensure the chain hash input is consistently reproducible across machines.
