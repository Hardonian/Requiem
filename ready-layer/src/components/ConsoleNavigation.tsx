...
const platformNavItems: NavItem[] = [
  ...
  },
  {
    ...
    icon: (
      <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M6.429 9.75 2.25 12l4.179 2.25m0-4.5 5.571 3 5.571-3m-11.142 0L2.25 7.5 12 2.25l9.75 5.25-4.179 2.25m0 0L21.75 12l-4.179 2.25m0 0L12 17.25 6.43 14.25m11.141 0-4.179 2.25m0 0L12 21.75" />
      </svg>
    ),
  },
  {
    ...
    <Link
      ...
      className={`flex items-center gap-2.5 rounded-lg px-3 py-2 text-sm font-medium transition-colors ${
        isActive
          ...
          : 'text-foreground/60 hover:bg-surface-elevated hover:text-foreground'
      }`}
    >
...
export function ConsoleNavigation() {
  return (
    <nav
      className="flex min-h-screen w-64 flex-col border-r border-border bg-surface"
    ...
    >
      ...
      <div className="flex-1 overflow-y-auto p-3 space-y-6">
        ...
        <div role="group" aria-label="Platform">
          <div className="px-3 mb-2 text-[10px] font-semibold text-muted uppercase tracking-widest">
            Platform
          </div>
