...
/**
 * ConsoleNavigation - Primary navigation for console pages
 * 
 * Simplified navigation structure per UX refinement:
 * - Logs
 * - Runs
 * - Plans
 * - Policies
    ...
    <nav className="w-64 bg-white dark:bg-gray-800 border-r border-gray-200 dark:border-gray-700 min-h-screen">
      ...
      <div className="p-4 border-b border-gray-200 dark:border-gray-700">
        <a href="/" className="flex items-center gap-2">
          ...
          <span className="font-bold text-lg text-gray-900 dark:text-white">Requiem</span>
        </a>
      </div>
