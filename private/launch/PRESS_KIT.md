...
- **Founded**: 2024
- **Core Technology**: Native C++ Engine, BLAKE3 Domain-Separated Hashing, Policy VM.
- **Key Products**: Reach CLI (OSS), ReadyLayer Cloud (Enterprise Control Plane).
- **Headquarters**: Remote-first / Toronto, Canada.
...
- **Primary Logo**: [Link to Internal Drive]
- **ReadyLayer Screenshots**: [Link to Internal Drive]
- **CLI In-Action Video**: [Link to Internal Drive]

## 5. Media Contact

Please direct all press inquiries to <press@requiem.sh>.
