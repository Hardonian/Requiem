...
export enum AiErrorCode {
  ...
  TOOL_DIGEST_MISMATCH = 'AI_TOOL_DIGEST_MISMATCH',
  ...
  TRIGGER_DATA_TOO_LARGE = 'AI_TRIGGER_DATA_TOO_LARGE',
  ...
  COST_ANOMALY_DETECTED = 'AI_COST_ANOMALY_DETECTED',
  ...
  RECURSION_DEPTH_EXCEEDED = 'AI_RECURSION_DEPTH_EXCEEDED',
...
export const AI_ERROR_HTTP_STATUS: Partial<Record<AiErrorCode, number>> = {
  ...
  [AiErrorCode.TOOL_OUTPUT_TOO_LARGE]: 413,
  [AiErrorCode.TRIGGER_DATA_TOO_LARGE]: 413,
  [AiErrorCode.TOOL_DIGEST_MISMATCH]: 409,
